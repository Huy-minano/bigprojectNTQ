          ...
          <div className={cx("inforMovie")}>
            ...
            <div className={cx("actions")}>
              <div className={cx("user-rate")}>
                <div className={cx("rate1")} style={{background:`linear-gradient(to left, rgb(53, 177, 64) ${persen}%, rgb(19, 78, 26) ${100-persen}%) right`}}></div>
              ...
              <div className={cx("play-trailer")} onClick={() => setOpen(true)}>
